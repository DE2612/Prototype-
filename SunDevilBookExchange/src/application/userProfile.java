...
public class userProfile extends CycledView {
	...
	userProfile(CycledView next1, CycledView next2, CycledView next3, CycledView next4, CycledView next5) {
	...
	void createGUI() {
	    ...
	    Label createAccount = new Label("User Profile");
	    createAccount.setStyle("-fx-min-width: 301px; /* Set minimum width */\r\n"
	    ...
	    createAccount.setLayoutX(895);
	    createAccount.setLayoutY(270);
	    
	    Instruction = new Label("Current ID: \nCurrent password: ");
	    ...
	    Label ID = new Label("New User Name: ");
	    ...
	    id_field.setPromptText("Enter new ID");
	    ...
	    Button create_btn = new Button("Update Credentials");
	    ...
	    create_btn.setOnMouseExited(e -> create_btn.setStyle("-fx-spacing: 15;\r\n"
	    		...
	    		+ "    -fx-font-size: 16px;              /* Font size */\r\n"
	    		+ "    -fx-alignment: center;            /* Text alignment */"));
	    create_btn.setLayoutX(896);
	    create_btn.setLayoutY(551);
		...
		create_btn.setOnAction((ActionEvent e) -> {
	    	...
	    	for (int i = 0; i < credentialsArray.size(); i++) {
	    		if (loginPage.log_id.equals(credentialsArray.get(i)) && loginPage.log_pass.equals(passwordArray.get(i))) {
	    			credentialsArray.remove(i);
	    	...
	    	mainMenuPage.welcomeName.setText("Welcome " + newID);
	    	getChildren().remove(Warning1);
    		getChildren().remove(Warning2);
			id_field.setText("");
