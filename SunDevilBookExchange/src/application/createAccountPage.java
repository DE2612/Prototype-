...
public class createAccountPage extends CycledView {
	
	createAccountPage(CycledView next1, CycledView next2, CycledView next3, CycledView next4, CycledView next5) {
	...
	void createGUI() {
	    ...
	    Label Instruction = new Label("Create account by entering your ﻿ASUID \nand password.");
		...
		Label Warning1 = new Label("Error: Please enter new ID or new password!");
