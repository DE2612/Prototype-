	...
	void createGUI() {
	  ...
	  //breck code
	  		...
	  		userProfile_btn.setOnAction(e -> {
	  			userProfile.Instruction.setText("Current ID: " + loginPage.log_id + "\nCurrent Password: " + loginPage.log_pass);
	  			callNext4();
	  		});
		...
		getChildren().addAll(titleRect, title, welcomeName, Instruction, buy_btn, sell_btn, log_out_btn, ASU);
